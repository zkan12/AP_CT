...
# Load the model
model = joblib.load(r"C:\Users\zhang\Desktop\CT.pkl")

# Define feature names
feature_names = [
"L1 Muscle Density", "L1 VAT Density", 
...
#    "TG", "TC", "HDL_C", "Hemoglobin", "CRP", "Amylase", "BUN", "Albumin","Blood_Glucose", "Serum sodium", "Calcium", "ALT",
